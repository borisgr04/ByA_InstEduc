<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBS.Master" AutoEventWireup="true" CodeBehind="DetalleNotaCredito.aspx.cs" Inherits="AspIdentity.NotaCredito.gNotasCredito.DetalleNotaCredito" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="js/cDetalleNotaCredito.js"></script>
    <div class="container" ng-app="Model">
        <div ng-controller="cDetalleNotaCredito" ng-cloak>
                                        ...
                                        <div class="panel panel-default" id="print">                                            
                                            <div class="panel-body">       
                                                ...
                                                <div class="row text-center">
                                                    <h3 style="margin:0px">NOTA CREDITO</h3>
                                                ...
                                                <div class="row" style="margin:10px">
                                                    <table class="table table-bordered table-hover table-striped tablesorter" id="Table1">
                                                        ...
                                                        <tbody>
                                                            <tr ng-repeat="detalle in liquidacion.detalles_nota_credito">
