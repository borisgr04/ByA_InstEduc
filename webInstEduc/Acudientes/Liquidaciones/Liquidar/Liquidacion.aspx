<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBS.Master" AutoEventWireup="true" CodeBehind="Liquidacion.aspx.cs" Inherits="AspIdentity.Acudientes.Liquidaciones.Liquidar.Liquidacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="js/cLiquidacion.js"></script>
            ...
            <div class="container">
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">Liquidar Periodo</div>
                        <div class="panel-body">
                            <div class="row">
                                <form name="datosLiquidacion">                                
                                    ...
                                    <div class="col-xs-2">                                        
                                        <button style="margin-top:21px" ng-click="_Back()" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-chevron-left"></span> Atrás</button>
                                    </div>
                                </form>
                            </div>
                            <hr />
                            <div class="form-group row">
                                <div class="col-xs-2">
                                    ...
                                    <select class="form-control" ng-change="_GetCarteraCausada()" disabled="disabled" ng-model="grupo_pago" ng-options="grupo_pago as grupo_pago.nombre for grupo_pago in grupos_pagos"></select> 
                                </div>
                                <div class="col-xs-1">
                                    <button style="margin-top:21px" ng-disabled="valor_a_liquidar==0 || !habGuardar" class="btn btn-info btn-xs" ng-click="_liquidar()"><span class="glyphicon glyphicon-usd"></span> Liquidar</button>
                                </div>
                            </div>
