...
app.controller('cDetalleLiquidacion', function ($scope, entidadService, gradosService, estudiantesService, cursosService, matriculasService, carteraService, pagosService, periodosService) {
    $scope.estudiante = {};
    $scope.entidad = {};
    ...
    _init();
    function _init() {
        byaSite.SetModuloP({ TituloForm: "Gestión", Modulo: "Liquidaciones", urlToPanelModulo: "gLiquidaciones.aspx", Cod_Mod: "PAGOS", Rol: "PAGOSGLiquid" });
