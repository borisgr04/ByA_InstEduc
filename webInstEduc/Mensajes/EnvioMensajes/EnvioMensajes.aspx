<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBS.Master" AutoEventWireup="true" CodeBehind="EnvioMensajes.aspx.cs" Inherits="AspIdentity.Mensajes.EnvioMensajes.EnvioMensajes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="js/cEnvioMensajes.js"></script>
        ...
        <div class="modal fade bs-example-modal-lg" id="modalMensaje" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog" role="document" style="width: 800px;">
                <div class="modal-content">
                    ...
                    <form ng-submit="registrarMensajes()">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-xs-6">
                                    <label>Asunto</label>
                                    <input type="text" class="form-control" ng-model="asunto" required="required"/>
                                </div>         
                                <div class="col-xs-6">
                                    <label>Tipo mensaje</label>
                                    <select class="form-control" ng-model="tipoMsje" required="required" ng-options="tipo as tipo.nombre for tipo in tipoMensaje track by tipo.id"></select>
                                </div>                            
                            </div>
                            <div class="row">
                                <div class="col-xs-2">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <textarea class="form-control" rows="4" required="required" ng-model="ContenidoMensaje"></textarea>
                                </div>
                            </div>
                        </div>
