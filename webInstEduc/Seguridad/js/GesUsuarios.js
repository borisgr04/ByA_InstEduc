var GesUsuarios = (function () {
    ...
    var urlToGridCon = "/Servicios/wsSeguridad.asmx/GetUsuarios";
    var urlToGuardarNuevo = "/Servicios/wsSeguridad.asmx/InsUsuarios";

    var urlToGuardarActivar = "/Servicios/wsSeguridad.asmx/ActivarUsuario";
    var urlToGuardarInactivar = "/Servicios/wsSeguridad.asmx/InactivarUsuario";
    var urlToGuardarDesbloquear = "/Servicios/wsSeguridad.asmx/DesbloquearUsuario";
    var urlToGuardarForzarPass = "/Servicios/wsSeguridad.asmx/Forzar_Cambio_Clave";
    var urlToGuardar;
...
$(function () {
    byaSite.SetModuloP({ TituloForm: "Panel de Administración", Modulo: "Seguridad", urlToPanelModulo: "PanelAdmin.aspx", Cod_Mod: "SEGUD", Rol: "SEGUDgesUsuarios" });
