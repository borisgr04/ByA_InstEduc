var PerfilxUsuario = (function () {
    ...
    var urlToGridCon = "/Servicios/wsSeguridad.asmx/GetRoles";
    var urlToRoles = "/Servicios/wsSeguridad.asmx/GetRolesJ";
    var urlToDetContratos = "GesDetContratos.aspx";
    var urlToFiltro = '/Servicios/wsContratosGestionC.asmx/GetDepContratos';
    var urlToGuardarRoles = "/Servicios/wsSeguridad.asmx/GuardarRoles";
    var msgPpal = "#LbMsg";
...
$(function () {
    byaSite.SetModuloP({ TituloForm: "Asinación de Roles a Usuarios", Modulo: "Seguridad", urlToPanelModulo: "gesUsuarios.aspx", Cod_Mod: "SEGU", Rol: "SG_SEC_USUARIO" });
