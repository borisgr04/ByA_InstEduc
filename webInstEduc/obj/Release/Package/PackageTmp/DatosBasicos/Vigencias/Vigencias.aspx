<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBS.Master" AutoEventWireup="true" CodeBehind="Vigencias.aspx.cs" Inherits="AspIdentity.DatosBasicos.Vigencias.Vigencias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="js/cVigencias.js"></script>
    <div class="container" ng-app="Model">
        <div ng-controller="cVigencias" ng-cloak>
                ...
                <div class="row" style="margin:10px">
                    <div class="col-xs-4">                        
                        ...
                        <table class="table table-bordered table-hover table-striped tablesorter">
                            ...
                            <tbody>
                                <tr ng-repeat="vigencia in vigencias">
                                    <td>
                                        <input type="number" class="form-control transparente" ng-model="vigencia.vigencia" required />                                        
                                    </td>
                                    <td>
                                        <select ng-model="vigencia.estado" class="form-control transparente" required>
