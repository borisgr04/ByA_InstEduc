...
app.controller('cInicioAdministrativo', function ($scope, gradosService, estudiantesService, cursosService, matriculasService, carteraService, pagosService, periodosService, estudiantessaldosService, fechaCausacionService) {
    $scope.estudiantes = [];
    $scope.estudiante = {};
    $scope.filtro = "";
    ...
    function _init() {
        ...
        byaSite.SetModuloP({ TituloForm: "Inicio", Modulo: "Administrativo", urlToPanelModulo: "Inicio.aspx", Cod_Mod: "INICI", Rol: "INICIAdministrativo" });
